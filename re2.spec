...
Version  : 2020.03.03
Release  : 13
URL      : https://github.com/google/re2/archive/2020-03-03/re2-2020.03.03.tar.gz
Source0  : https://github.com/google/re2/archive/2020-03-03/re2-2020.03.03.tar.gz
...
%prep
%setup -q -n re2-2020-03-03
cd %{_builddir}/re2-2020-03-03
pushd ..
cp -a re2-2020-03-03 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583249945
...
cp %{_builddir}/re2-2020-03-03/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141
pushd ../buildavx2/
