...
Version  : 2020.07.06
Release  : 18
URL      : https://github.com/google/re2/archive/2020-07-06/re2-2020.07.06.tar.gz
Source0  : https://github.com/google/re2/archive/2020-07-06/re2-2020.07.06.tar.gz
...
%prep
%setup -q -n re2-2020-07-06
cd %{_builddir}/re2-2020-07-06
pushd ..
cp -a re2-2020-07-06 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594051231
...
cp %{_builddir}/re2-2020-07-06/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141
cp %{_builddir}/re2-2020-07-06/re2/fuzzing/compiler-rt/LICENSE %{buildroot}/usr/share/package-licenses/re2/483d1c97dc79ef8741eae507897ca39cfe19da36
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/haswell/libre2.so.8
/usr/lib64/haswell/libre2.so.8.0.0
/usr/lib64/libre2.so.8
/usr/lib64/libre2.so.8.0.0
