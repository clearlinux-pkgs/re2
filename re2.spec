...
Version  : 2024.05.01
Release  : 58
URL      : https://github.com/google/re2/archive/2024-05-01/re2-2024.05.01.tar.gz
Source0  : https://github.com/google/re2/archive/2024-05-01/re2-2024.05.01.tar.gz
...
%prep
%setup -q -n re2-2024-05-01
cd %{_builddir}/re2-2024-05-01
pushd ..
cp -a re2-2024-05-01 buildavx2
popd
pushd ..
cp -a re2-2024-05-01 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716493994
...
cp %{_builddir}/re2-2024-05-01/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141 || :
cp %{_builddir}/re2-2024-05-01/python/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
