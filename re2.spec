...
%prep
%setup -q -n re2-2024-07-02
cd %{_builddir}/re2-2024-07-02
pushd ..
cp -a re2-2024-07-02 buildavx2
popd
pushd ..
cp -a re2-2024-07-02 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720036396
...
cp %{_builddir}/re2-2024-07-02/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141 || :
cp %{_builddir}/re2-2024-07-02/python/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
