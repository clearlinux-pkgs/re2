...
Source0  : https://github.com/google/re2/archive/2019-07-01/re2-2019.07.01.tar.gz
...
%prep
%setup -q -n re2-2019-07-01
pushd ..
cp -a re2-2019-07-01 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562144460
