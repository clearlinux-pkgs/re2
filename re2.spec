...
Source0  : https://github.com/google/re2/archive/2019-06-01/re2-2019.06.01.tar.gz
...
%prep
%setup -q -n re2-2019-06-01
pushd ..
cp -a re2-2019-06-01 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1559666703
export AR=gcc-ar
