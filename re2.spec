...
Source0  : https://github.com/google/re2/archive/2019-04-01/re2-2019.04.01.tar.gz
...
%prep
%setup -q -n re2-2019-04-01
pushd ..
cp -a re2-2019-04-01 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1554252384
export AR=gcc-ar
