...
Version  : 2020.03.02
Release  : 12
URL      : https://github.com/google/re2/archive/2020-03-02/re2-2020.03.02.tar.gz
Source0  : https://github.com/google/re2/archive/2020-03-02/re2-2020.03.02.tar.gz
...
%prep
%setup -q -n re2-2020-03-02
cd %{_builddir}/re2-2020-03-02
pushd ..
cp -a re2-2020-03-02 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583164922
...
cp %{_builddir}/re2-2020-03-02/LICENSE %{buildroot}/usr/share/package-licenses/re2/e310076ee4f65219003bfae2427646e0236c5141
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/haswell/libre2.so.1
/usr/lib64/haswell/libre2.so.1.0.0
/usr/lib64/libre2.so.1
/usr/lib64/libre2.so.1.0.0
